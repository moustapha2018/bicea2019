 ...
 */
final class Version20191114202102 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE pr_task (id INT AUTO_INCREMENT NOT NULL, bicea_admin_id INT DEFAULT NULL, task_name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, comment VARCHAR(255) NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_FE97FFBCD9E6DAE7 (bicea_admin_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
